      ...
      <main className="main" style={{display:'flex',flexDirection:'column',height:'calc(100vh - 0px)',padding:0}}>
        <div style={{padding:'16px 24px',borderBottom:'1px solid var(--border)',background:'var(--surface)',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
          <div style={{display:'flex',alignItems:'center',gap:12}}>
            <div style={{width:40,height:40,borderRadius:10,background:'var(--sidebar-bg)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:20}}><Icons.AI /></div>
        ...
        <div style={{flex:1,overflowY:'auto',padding:'20px 24px'}}>
          {mensajes.length===0 ? (
            <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'100%',gap:24}}>
              <div style={{textAlign:'center'}}><div style={{fontSize:56,marginBottom:12}}><Icons.AI /></div><h2 style={{fontSize:20,fontWeight:700,margin:'0 0 8px'}}>¿En qué te puedo ayudar?</h2><p style={{fontSize:14,color:'var(--text-muted)',margin:0}}>Tengo acceso a los datos reales de tu congregación.</p></div>
            ...
            <div>
              ...
              {loading&&(
                <div style={{display:'flex',gap:10,alignItems:'flex-start',marginBottom:16}}>
                  <div style={{width:32,height:32,borderRadius:'50%',background:'var(--sidebar-bg)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:16}}><Icons.AI /></div>
