/**
 * MinIcons — iconos SVG profesionales para el módulo de ministerios.
 * Reemplaza emojis y mantiene una línea visual consistente en mobile.
 */
...
export const Mixer = icon(
  <>
    ...
    <rect x="10" y="8" width="4" height="4" rx="1" stroke="currentColor" strokeWidth="2" />
    <rect x="18" y="12" width="4" height="4" rx="1" stroke="currentColor" strokeWidth="2" />
  </>,
)
...
export const DoorOpen = icon(
  <>
    <path d="M13 4H3v16h10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export const Child = icon(
  <>
    ...
    <path d="M9 8h6l1 8H8l1-8z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M9 11l-2 5M15 11l2 5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  </>,
)
...
export const Sprout = icon(
  <>
    ...
    <path
      d="M12 12C12 12 7 10 7 5c0 0 2.5-3 5-3s5 3 5 3c0 5-5 7-5 7z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path d="M12 16c0 0-4 0-6 4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  </>,
)
...
export const Handshake = icon(
  <>
    ...
    />
    <path
      d="M12 5.36L8.87 8.5a2.13 2.13 0 0 0 0 3 2.13 2.13 0 0 0 3.13-3L10.18 6.68"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const HandsPraying = icon(
  <>
    <path
      d="M12 2v4M12 18v4M8 6l-4 4 4 4M16 6l4 4-4 4"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const Building = icon(
  <>
    <rect x="3" y="9" width="18" height="13" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M8 22V12h8v10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M3 9l9-7 9 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </>,
)
...
export const MINISTERIO_ICONS = {
  ...
  JUVENTUD: Zap,
  EVANGELISMO: Globe,
  CONSOLIDACION_MIN: Sprout,
  VOLUNTARIADO: Handshake,
  COMUNICACIONES: Megaphone,
  ADMINISTRACION: FolderOpen,
  ORACION_CUIDADO: HandsPraying,
  EVENTOS_CAMPANAS: Flag,
  MANTENIMIENTO: Wrench,
  SEGURIDAD: ShieldCross,
