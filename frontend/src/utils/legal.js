...
export const TEXTOS = {
  checkboxRegistro: 'Acepto los Términos y Condiciones, la Política de Privacidad y la Política de Cookies de Church System.',
  aviso: 'Church System es una herramienta tecnológica de gestión. La organización usuaria es responsable por los datos que carga, los permisos que asigna y las comunicaciones que envía.',
